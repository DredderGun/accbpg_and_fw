...
def poisson_regr_in_simplex():
    ...
    n = 1000
    radius = 1
    f, [h, h_kl, h_sq], L, x0, solution = accbpg.Poisson_regr_simplex(m, n, radius=radius, noise=0.001, lamda=0.001, randseed=2024)

    x00_FW, F00_FW, G00_FW, T00_FW, alphas = accbpg.FW_alg_div_step(f, h, L, x0, lmo=accbpg.lmo_simplex(radius), maxitrs=N, gamma=2.0,
