...
from .applications import D_opt_libsvm, D_opt_design, D_opt_KYinit, Poisson_regrL1, Poisson_regrL2, KL_nonneg_regr, Poisson_regrL2_ball, svm_digits_ds_divs_ball, smv_digits_ds_divs_simplex, distributed_ridge_regression_problem
